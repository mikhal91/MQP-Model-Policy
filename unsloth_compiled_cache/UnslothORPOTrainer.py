...
from trl.trainer.orpo_trainer import (Any, AutoModelForCausalLM, BaseImageProcessor, Callable, DPODataCollatorWithPadding, DataCollator, DataLoader, Dataset, EvalLoopOutput, F, FeatureExtractionMixin, Literal, ORPOConfig, ORPOTrainer, Optional, PartialState, PeftModel, PreTrainedModel, PreTrainedModelWrapper, PreTrainedTokenizerBase, ProcessorMixin, Trainer, TrainerCallback, Union, add_bos_token_if_needed, add_eos_token_if_needed, amp, deepcopy, defaultdict, deprecate_kwarg, disable_dropout_in_model, generate_model_card, get_comet_experiment_url, inspect, is_peft_available, is_torch_fx_proxy, is_torch_xla_available, is_wandb_available, maybe_apply_chat_template, maybe_extract_prompt, nn, np, nullcontext, os, pad_to_length, peft_module_casting_to_bf16, prepare_model_for_kbit_training, random, textwrap, torch, transformers, version, warnings)
